...
import android.zero.studio.uidesigner.databinding.LayoutColorDialogBinding;
import android.zero.studio.uidesigner.views.ColorView;
...
public class ColorDialog extends AttributeDialog
    ...
    // Declaring Views
    private final ColorView colorPreview;
    private final AppCompatSeekBar seekAlpha;
    private final AppCompatSeekBar seekRed;
    private final AppCompatSeekBar seekGreen;
    private final AppCompatSeekBar seekBlue;
    private final TextInputLayout inputLayout;
    private final TextInputLayout aInputLayout;
    private final TextInputLayout rInputLayout;
    private final TextInputLayout gInputLayout;
    private final TextInputLayout bInputLayout;
    private final TextInputEditText editText;
    private final TextInputEditText aEdittext;
    private final TextInputEditText rEdittext;
    private final TextInputEditText gEdittext;
    private final TextInputEditText bEdittext;
    ...
    public ColorDialog(Context context, String savedValue) {
        ...
        android.zero.studio.uidesigner.databinding.LayoutColorDialogBinding binding = LayoutColorDialogBinding.inflate(getDialog().getLayoutInflater());
