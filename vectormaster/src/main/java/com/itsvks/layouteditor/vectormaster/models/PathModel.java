package android.zero.studio.vectormaster.models;
...
import android.zero.studio.vectormaster.DefaultValues;
import android.zero.studio.vectormaster.utilities.Utils;
import android.zero.studio.vectormaster.utilities.parser.PathParser;
...
public class PathModel {
    ...
    public void buildPath(boolean useLegacyParser) {
        if (pathData != null) {
            if (useLegacyParser) {
                originalPath =
                    android.zero.studio.vectormaster.utilities.legacyparser.PathParser
